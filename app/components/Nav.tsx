    ...
    <>
      <nav
        style={{
          ...
          right: 0,
          zIndex: 500,
          background: scrolled ? 'rgba(54,80,113,0.97)' : 'transparent',
      ...
      >
        <div className="container-balzer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '72px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <Link href="/menu" className="btn-outline-white hidden-mobile" style={{ padding: '0.6rem 1.5rem', fontSize: '0.6rem' }}>
              Sfoglia il menu
            </Link>
            <button
              aria-label="Menu"
      ...
      {open && (
        ...
        >
          ...
          <Link href="/menu" className="btn-outline-white" onClick={() => setOpen(false)} style={{ marginTop: '1rem' }}>
            Sfoglia il menu
          </Link>
        </div>
      )}
